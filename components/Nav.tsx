...
const SmNav = () => {
  ...
  function toggleHeight() {
    if (dropHeight === "0px") setDropHeight("220px");
    if (dropHeight === "220px") setDropHeight("0px");
  }
  ...
  return (
    <nav className={classes.smNavbar}>
      ...
      <div className={classes.dropdown} style={{ height: dropHeight }}>
        <div className={classes.cols}>
          <ul className={classes.smLinks}>
            <li onClick={scrollToCaseStudies}>Our Work</li>
            <li onClick={scrollToWhyUs}>Why Choose Us</li>
            <li onClick={() => setDropHeight("0px")}>
              <Link href="/case-studies">Case Studies</Link>
            </li>
            <li onClick={() => setDropHeight("0px")}>
              <Link href="/about-us">About Us</Link>
          ...
          <div className={classes.btnBox}>
            <Link href="/contact">
              <button className={classes.contactSm} onClick={toggleHeight}>
                Contact
              </button>
            </Link>
          </div>
